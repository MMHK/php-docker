...
# base layer
RUN install-php-extensions @composer gd memcached gettext imagick mcrypt mysqli redis-^5.3.7 pdo_mysql opcache exif bcmath soap sockets timezonedb zip snmp bz2 iconv \
